package br.com.clinicamedica.Clinica.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<CustomExceptionResponse> handleDuplicateUserNameException(Exception e,
                                                                                          WebRequest request) {
    ...
    public final ResponseEntity<CustomExceptionResponse> handleInvalidJwtAuthenticationException(Exception e,
                                                                                                 WebRequest request) {
        CustomExceptionResponse response = new CustomExceptionResponse(new Date(), e.getMessage(),
                request.getDescription(false));
